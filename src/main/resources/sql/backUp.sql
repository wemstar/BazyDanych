...
--
-- Name: project; Type: SCHEMA; Schema: -; Owner: i1macura
--

CREATE SCHEMA project;


ALTER SCHEMA project OWNER TO i1macura;
...
--
-- Name: action; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--

CREATE TABLE action (
    name character varying(255) NOT NULL,
    ability character varying(255),
    triger character varying(255),
    type character varying(255)
);


ALTER TABLE project.action OWNER TO i1macura;

--
-- Name: card; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--

CREATE TABLE card (
    name character varying(255) NOT NULL,
    addicionallcost integer,
    basiccost integer,
    count integer,
    defence integer,
    image bytea,
    ...
    edition_name character varying(255) NOT NULL,
    race_name character varying(255) NOT NULL,
    type_name character varying(255) NOT NULL
);


ALTER TABLE project.card OWNER TO i1macura;

--
-- Name: card_action; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--
...
ALTER TABLE project.card_action OWNER TO i1macura;

--
-- Name: card_deck; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--

CREATE TABLE card_deck (
    deck_id character varying(255) NOT NULL,
    card_id character varying(255) NOT NULL
);


ALTER TABLE project.card_deck OWNER TO i1macura;

--
-- Name: deck; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--

CREATE TABLE deck (
    name character varying(255) NOT NULL,
    basic_race_name character varying(255) NOT NULL,
    user_nick character varying(255) NOT NULL
);


ALTER TABLE project.deck OWNER TO i1macura;

--
-- Name: edition; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--
...
ALTER TABLE project.edition OWNER TO i1macura;

--
-- Name: race; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--

CREATE TABLE race (
    name character varying(255) NOT NULL,
    fraction character varying(255)
);


ALTER TABLE project.race OWNER TO i1macura;

--
-- Name: type; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--
...
ALTER TABLE project.type OWNER TO i1macura;

--
-- Name: user; Type: TABLE; Schema: project; Owner: i1macura; Tablespace: 
--
...
ALTER TABLE project."user" OWNER TO i1macura;

--
-- Data for Name: action; Type: TABLE DATA; Schema: project; Owner: i1macura
--
